#!/bin/bash
# Discoverer/Slurm launcher for B1 200-start success/path evaluation.

#SBATCH --partition=common
#SBATCH --qos=bg-eng-01
#SBATCH --account=bg-eng-01
#SBATCH --job-name=lewm_b1_eval200
...
#SBATCH --gres=gpu:1
#SBATCH --exclude=dgx1
#SBATCH -o logs/lewm_b1_eval200.%j.out
#SBATCH -e logs/lewm_b1_eval200.%j.err
...
POLICY="${POLICY:-lewm_reacher_b1_effect/weights_epoch_3.pt}"
...
OUTPUT_JSON="${OUTPUT_JSON:-${STABLEWM_HOME}/checkpoints/reacher_workshop/b1_effect_eval200_${SAMPLE_OFFSET}.json}"
PATHS_JSON="${PATHS_JSON:-${STABLEWM_HOME}/checkpoints/reacher_workshop/b1_effect_eval200_paths_${SAMPLE_OFFSET}.json}"
